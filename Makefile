...
USERINC += ./src_motor/motor_access
USERINC += ./src_motor/motor_control
USERINC += ./src_motor/motor_trignometry

USERINC += ./src_pid/pid_access

USERINC += ./src_system/system_driver
USERINC += ./src_system/system_usb
...
USERSRC += ./src_motor/motor_control/motor_control.c
USERSRC += ./src_motor/motor_trignometry/trignometry_pwm.c

USERSRC += ./src_pid/pid_access/pid_access.c
...
USERSRC += ./src_rc_input/rc_input.c
